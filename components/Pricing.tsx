    ...
    <div className='relative bg-gradient-to-b from-[#b83e3e15] to-[#FFFFFF] min-h-screen pt-[204px]'>
      ...
      <div className='md:w-[1073px] w-[330px] h-[217px] mt-[58px] mx-auto flex flex-col md:flex-row justify-between md:items-start items-center px-8'>
        <div className='w-max flex md:block flex-col items-center gap-9'>
          ...
          <button className='w-max rounded-[100px] md:text-base text-sm leading-[26px] font-bold border md:px-[22px] py-2 px-3 border-[#FFFFFF29] bg-black flex items-center gap-2 mt-[19px]'>
